...
namespace AlphaUtilityWF
{
	...
	public class KnobControl : System.Windows.Forms.UserControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			// Draw border of knob                         
            gOffScreen.DrawEllipse(new Pen(Color.Gray), rKnob);
            ...
            Utility.DrawInsetCircle(ref gOffScreen, new Rectangle(Arrow.X - 3, Arrow.Y - 3, 6, 6), new Pen(Color.Black));
